export default function WhatsAppButton() {
  const number = import.meta.env.VITE_WHATSAPP_NUMBER || '234XXXXXXXXXX'
  const text = encodeURIComponent('Hello ZACO, I want to study abroad')
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[80] w-14 h-14 rounded-full bg-[#25D366] shadow-[0_4px_24px_rgba(37,211,102,0.35)] flex items-center justify-center hover:scale-110 transition-transform"
    >
